...
Scenario: Escenario iniciar sesión y ver sitio
  ...
  When I need take a screenshot "iniciar-sesion/1-step-ir-a-login"
  When I enter email "<EMAIL>"
  And I need take a screenshot "iniciar-sesion/2-step-ingresar-email"
  And I enter password "<PASSWORD>"
  And I need take a screenshot "iniciar-sesion/3-step-ingresar-password"
  And I click signin
  And I need take a screenshot "iniciar-sesion/4-step-click-iniciar-sesion"
  And I wait for 7 seconds
  Then I see site link into site
  And I need take a screenshot "iniciar-sesion/5-step-assert"
