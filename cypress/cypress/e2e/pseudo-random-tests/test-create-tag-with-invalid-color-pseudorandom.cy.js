...
describe('Escenario creación de Tags', () => {
  ...
  it('Crear una nuevo tag con color invalido', () => {
    cy.fixture('login-data.json').then(function (user) {
      ...
      tagClient.getTagsInvalidColor().then(function (body){
        ...
        cy.contains('The color should be in valid hex format').should('exist')
