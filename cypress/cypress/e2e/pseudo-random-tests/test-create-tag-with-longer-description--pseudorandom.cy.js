...
describe('Escenario creación de Tags', () => {
  ...
  it('Crear una nuevo tag con descripcion con longitud superior a la máxima 500', () => {
    cy.fixture('login-data.json').then(function (user) {
      ...
      tagClient.getTagsLongerDescription().then(function (body){
        ...
        cy.contains('Description cannot be longer than 500 characters.').should('exist')
